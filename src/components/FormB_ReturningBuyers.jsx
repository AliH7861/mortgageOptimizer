...
const FloatingInput = ({ label, type, name, step, value, onChange, increment, decrement }) => (
  <div className="relative">
    ...
    {/* Custom arrows for number inputs */}
    {type === "number" && (
            ...
            <div className="rounded-2xl bg-black/40 backdrop-blur-lg p-6 
              ...
              <div className="grid grid-cols-2 gap-4">
                <FloatingInput
                  ...
                  onChange={handleChange}
                  increment={() => increment("currentPropertyValue")}
                  decrement={() => decrement("currentPropertyValue")}
                />
                <FloatingInput
                  type="number"
                  ...
                  onChange={handleChange}
                  increment={() => increment("currentMortgageBalance")}
                  decrement={() => decrement("currentMortgageBalance")}
                />
                <FloatingInput
                  type="number"
                  step="0.01"
                  ...
                  onChange={handleChange}
                  increment={() => increment("currentInterestRate", 0.01)}
                  decrement={() => decrement("currentInterestRate", 0.01)}
                />
                <FloatingInput
                  type="text"
                  name="currentRateType"
                  label="Rate Type (Fixed/Variable)"
                ...
                <FloatingInput
                  ...
                  onChange={handleChange}
                  increment={() => increment("mortgageTermYears")}
                  decrement={() => decrement("mortgageTermYears")}
                />
                <FloatingInput
                  type="number"
                  name="remainingAmortizationYears"
                  label="Remaining Amortization (Years)"
                  value={formData.remainingAmortizationYears}
                  onChange={handleChange}
                  increment={() => increment("remainingAmortizationYears")}
                  decrement={() => decrement("remainingAmortizationYears")}
                />
                <FloatingInput
                  type="number"
                  ...
                  onChange={handleChange}
                  increment={() => increment("currentMonthlyPayment")}
                  decrement={() => decrement("currentMonthlyPayment")}
                />
              </div>
            </div>
          </div>
